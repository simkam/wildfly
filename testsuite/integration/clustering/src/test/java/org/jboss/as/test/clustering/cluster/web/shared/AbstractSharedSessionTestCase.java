...
public abstract class AbstractSharedSessionTestCase extends AbstractClusteringTestCase {
    ...
    private static String MODULE_1;
    private static String MODULE_2;

    static Archive<?> getBaseDeployment(final String modulePrefix, final String jbossConfigurationFile) {
        MODULE = modulePrefix + "shared";
        MODULE_1 = modulePrefix + "war1";
        MODULE_2 = modulePrefix + "war2";
        ...
        ear.addAsManifestResource(AbstractSharedSessionTestCase.class.getPackage(), jbossConfigurationFile, "jboss-all.xml");
        return ear;
    }
