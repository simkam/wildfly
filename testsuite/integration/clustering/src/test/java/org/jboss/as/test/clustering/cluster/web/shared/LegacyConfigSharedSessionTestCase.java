...
public class LegacyConfigSharedSessionTestCase extends AbstractSharedSessionTestCase {
    private static final String MODULE_PREFIX = LegacyConfigSharedSessionTestCase.class.getSimpleName() + '-';
    ...
    private static Archive<?> getDeployment() {
        return getBaseDeployment(MODULE_PREFIX, "jboss-all_legacy_1_0.xml");
    }
}
