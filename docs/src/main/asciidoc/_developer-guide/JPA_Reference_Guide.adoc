...
|Hibernate51CompatibilityTransformer.sessImplMtds| if true, the transformer will also change all org.hibernate.engine.spi.SessionImplementor parameters to type org.hibernate.engine.spi.SharedSessionContractImplementor|false
